...
use reqwest::Url;
use thor::create::{Alice0, Bob0, BuildFundingPSBT, Party6, SignFundingPSBT};
...
pub async fn make_actors(
    ...
    let alice = Alice0::new(alice_balance, time_lock);
    let bob = Bob0::new(bob_balance, time_lock);
